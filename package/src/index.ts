 ...
 * ```
 */
export function capitalizeWordsSimple(str: string): string {
 ...
 * ```
 */
export function capitalizeWordsUnicode(str: string, locale?: string): string {
  if (typeof str !== 'string') return '';
 ...
 */
export function isValidCapitalizeInput(value: unknown): value is string {
